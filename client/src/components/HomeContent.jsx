...
const HomeContent = () => {
  return (
    <div className='container'>
      ...
      <br />
      <div>
        <p>Radon is a radioactive gas that is odorless and colorless. It is released during the natural breakdown of uranium and radium found in almost all types of rocks and soils. Radon can seep into buildings through cracks or gaps in floors and walls that are in contact with the ground.
